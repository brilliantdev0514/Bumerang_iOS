...
class AddCaravanVC: BaseViewController {
    ...
    @IBOutlet weak var ui_bedTxt: UITextField!
    ...
    @IBOutlet weak var ui_weightDropdown: DropDown!
    ...
    override func viewDidLoad() {
        ...
        ui_fuelDropDown.didSelect{(selectedText , index , id) in
            self.fuelState = selectedText
        }
        
        let weightOption = WeightLimitOption()
        ui_weightDropdown.optionArray = weightOption.values
        ui_weightDropdown.optionIds = weightOption.ids
        ui_weightDropdown.checkMarkEnabled = false
        ui_weightDropdown.didSelect{(selectedText , index , id) in
            self.weightState = selectedText
        }
    ...
    func updateView() {
        ...
        ui_bedTxt.text = oneProduct?.bed_capacity

        fuelState = oneProduct!.fuel_type
        ui_fuelDropDown.text = fuelState
        ...
        weightState = oneProduct!.gear_type
        ui_weightDropdown.text = weightState
    ...
    @IBAction func onClickUpload(_ sender: Any) {
        ...
        else if bedTxt.isEmpty {
            showStr = R_EN.string.ENTER_PRODUCT_BED
        }
        else if fuelState.isEmpty {
                            ...
                            uploadMedia() { url in
                              guard let url = url else {
                                ...
                                if self.oneProduct != nil {
                                    ...
                                    self.gotoUpdateCaravanApi(title: titleTxt, bednum: bedTxt, fuel: self.fuelState, priceType: priceOption[self.selectedPeriod], priceVal: priceTxt, deposition: self.depositState, description: desciptTxt, image: self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                                } else {
                                    
                                    self.gotoUploadCaravanApi(title: titleTxt, bednum: bedTxt, fuel: self.fuelState, priceType: priceOption[self.selectedPeriod], priceVal: priceTxt, deposition: self.depositState, description: desciptTxt, image: self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                                }
    ...
    func gotoUploadCaravanApi(title: String, bednum: String, fuel : String, priceType : String, priceVal : String, deposition : String, description : String, image : Array<Any>, addr : String, lat : String, lng : String, zipCode: String) {
        
        let ownerid = Auth.auth().currentUser!.uid
        let productId = UUID().uuidString
        
        let productDict: [String: Any] = [ProductData.title: title, ProductData.room_number: "", ProductData.heating: "", ProductData.furbished: "", ProductData.date_unit: priceType, ProductData.price: priceVal, ProductData.deposit: deposition, ProductData.description: description, ProductData.address: addr, ProductData.lat: lat, ProductData.lng: lng, ProductData.zip_code: zipCode, ProductData.owner_id: ownerid, ProductData.image_url: uplodimgarray, ProductData.bed_capacity: bednum, ProductData.captan: "", ProductData.car_type: "", ProductData.category: "2", ProductData.color: "", ProductData.created_at: "", ProductData.door_number: "", ProductData.fuel_type: fuel, ProductData.gear_type: "", ProductData.gender: "", ProductData.membershipState: "", ProductData.person_capacity: "", ProductData.rental_status: "", ProductData.score: "", ProductData.size: "", ProductData.updated_at: "", ProductData.product_id: productId]
    ...
    func gotoUpdateCaravanApi(title: String, bednum: String, fuel : String, priceType : String, priceVal : String, deposition : String, description : String, image : Array<Any>, addr : String, lat : String, lng : String, zipCode: String) {
        
        let ownerid = Auth.auth().currentUser!.uid
        
        let productDict: [String: Any] = [ProductData.title: title, ProductData.room_number: "", ProductData.heating: "", ProductData.furbished: "", ProductData.date_unit: priceType, ProductData.price: priceVal, ProductData.deposit: deposition, ProductData.description: description, ProductData.address: addr, ProductData.lat: lat, ProductData.lng: lng, ProductData.zip_code: zipCode, ProductData.owner_id: ownerid, ProductData.image_url: uplodimgarray, ProductData.bed_capacity: bednum, ProductData.captan: "", ProductData.car_type: "", ProductData.category: "3", ProductData.color: "", ProductData.created_at: "", ProductData.door_number: "", ProductData.fuel_type: fuel, ProductData.gear_type: "", ProductData.gender: "", ProductData.membershipState: ShareData.user_info.membership!, ProductData.person_capacity: "", ProductData.rental_status: "", ProductData.score: "", ProductData.size: "", ProductData.updated_at: ""]
    ...
    extension AddCaravanVC:  UIImagePickerControllerDelegate, UINavigationControllerDelegate{
...
extension AddCaravanVC: SearchViewControllerDelegate {
...
extension AddCaravanVC : UICollectionViewDelegate,UICollectionViewDataSource
{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
