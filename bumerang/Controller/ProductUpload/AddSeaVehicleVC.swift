...
class AddSeaVehicleVC: BaseViewController {
    ...
    @IBOutlet weak var ui_pearsonTxt: UITextField!
    @IBOutlet weak var ui_captanDropDown: DropDown!
    @IBOutlet weak var ui_priceTxt: UITextField!
    @IBOutlet weak var ui_hourRadio: GDCheckbox!
    ...
    override func viewDidLoad() {
        ...
        let captanOption = BoolTypeOption()
        ui_captanDropDown.optionArray = captanOption.values
        ui_captanDropDown.optionIds = captanOption.ids
        ui_captanDropDown.checkMarkEnabled = false
        ui_captanDropDown.didSelect{(selectedText , index , id) in
            self.captanState = selectedText
        }
    ...
    func updateView() {
        ...
        ui_pearsonTxt.text = oneProduct?.person_capacity

        captanState = oneProduct!.captan
        ui_captanDropDown.text = captanState
        ui_priceTxt.text = oneProduct?.price
        if oneProduct?.date_unit == "Gün" {
            
            selectedPeriod = 1
            ui_hourRadio.isOn = true
    ...
    @IBAction func onClickHourly(_ sender: Any) {
        ui_hourRadio.isOn = true
        getPeriodVal(4)
    }
  ...
  func selectImage(){
    ...
    @IBAction func onClickUpload(_ sender: Any) {
        ...
        let personTxt = ui_pearsonTxt.text!
        ...
        else if personTxt.isEmpty {
            showStr = R_EN.string.ENTER_PRODUCT_BED
        }
        else if captanState.isEmpty {
            showStr = R_EN.string.SELECT_CAPTAN
        }
            ...
            self.showALLoadingViewWithTitle(title: "İlanlar yükleniyor ", type: .messageWithIndicator )
                            ...
                            uploadMedia() { url in
                                ...
                                if self.oneProduct != nil {
                                    ...
                                    self.gotoUpdateApi(title: titleTxt, person: personTxt, captan: self.captanState, priceType: priceOption[self.selectedPeriod], price : priceTxt, description : desciptTxt, image: self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                                } else {
                                    
                                    self.gotoUploadApi(title: titleTxt, person: personTxt, captan: self.captanState, priceType: priceOption[self.selectedPeriod], price : priceTxt, description : desciptTxt, image: self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                                    }
                                }
    ...
    func gotoUploadApi(title: String, person: String, captan: String, priceType: String, price : String, description : String, image: Array<Any>, addr : String, lat : String, lng : String, zipCode: String) {
            
        let ownerid = Auth.auth().currentUser!.uid
        let productId = UUID().uuidString
        
        let productDict: [String: Any] = [ProductData.title: title, ProductData.room_number: "", ProductData.heating: "", ProductData.furbished: "", ProductData.date_unit: priceType, ProductData.price: price, ProductData.deposit: "", ProductData.description: description, ProductData.address: addr, ProductData.lat: lat, ProductData.lng: lng, ProductData.zip_code: zipCode, ProductData.owner_id: ownerid, ProductData.image_url: uplodimgarray, ProductData.bed_capacity: "", ProductData.captan: captan, ProductData.car_type: "", ProductData.category: "3", ProductData.color: "", ProductData.created_at: "", ProductData.door_number: "", ProductData.fuel_type: "", ProductData.gear_type: "", ProductData.gender: "", ProductData.membershipState: "", ProductData.person_capacity: person, ProductData.rental_status: "", ProductData.score: "", ProductData.size: "", ProductData.updated_at: "", ProductData.product_id: productId]
    ...
    func gotoUpdateApi(title: String, person: String, captan: String, priceType: String, price : String, description : String, image: Array<Any>, addr : String, lat : String, lng : String, zipCode: String) {
            
        let ownerid = Auth.auth().currentUser!.uid
        
        let productDict: [String: Any] = [ProductData.title: title, ProductData.room_number: "", ProductData.heating: "", ProductData.furbished: "", ProductData.date_unit: priceType, ProductData.price: price, ProductData.deposit: "", ProductData.description: description, ProductData.address: addr, ProductData.lat: lat, ProductData.lng: lng, ProductData.zip_code: zipCode, ProductData.owner_id: ownerid, ProductData.image_url: uplodimgarray, ProductData.bed_capacity: "", ProductData.captan: captan, ProductData.car_type: "", ProductData.category: "4", ProductData.color: "", ProductData.created_at: "", ProductData.door_number: "", ProductData.fuel_type: "", ProductData.gear_type: "", ProductData.gender: "", ProductData.membershipState: ShareData.user_info.membership!, ProductData.person_capacity: person, ProductData.rental_status: "", ProductData.score: "", ProductData.size: "", ProductData.updated_at: ""]
...
//        ui_bedTxt.text = ""
    ...
    extension AddSeaVehicleVC:  UIImagePickerControllerDelegate, UINavigationControllerDelegate{
...
extension AddSeaVehicleVC: SearchViewControllerDelegate {
...
extension AddSeaVehicleVC : UICollectionViewDelegate,UICollectionViewDataSource
{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
