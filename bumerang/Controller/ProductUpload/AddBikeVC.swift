...
class AddBikeVC: BaseViewController {
            ...
            self.showALLoadingViewWithTitle(title: "İlanlar yükleniyor ", type: .messageWithIndicator )
                       ...
                       uploadMedia() { url in
                        ...
                        if self.oneProduct != nil {
                            ...
                            self.gotoUpdateBikeApi(title: title, priceType: priceOption[self.selectedPeriod], price: price, description: descript, image:  self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                        } else {
                            
                            self.gotoUploadBikeApi(title: title, priceType: priceOption[self.selectedPeriod], price: price, description: descript, image:  self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                        }
    ...
    func gotoUpdateBikeApi(title: String, priceType: String, price : String, description : String, image: Array<Any>, addr : String, lat : String, lng : String, zipCode: String) {
           
           let ownerid = Auth.auth().currentUser!.uid
           
           let productDict: [String: Any] = [ProductData.title: title, ProductData.room_number: "", ProductData.heating: "", ProductData.furbished: "", ProductData.date_unit: priceType, ProductData.price: price, ProductData.deposit: "", ProductData.description: description, ProductData.address: addr, ProductData.lat: lat, ProductData.lng: lng, ProductData.zip_code: zipCode, ProductData.owner_id: ownerid, ProductData.image_url: uplodimgarray, ProductData.bed_capacity: "", ProductData.captan: "", ProductData.car_type: "", ProductData.category: "6", ProductData.color: "", ProductData.created_at: "", ProductData.door_number: "", ProductData.fuel_type: "", ProductData.gear_type: "", ProductData.gender: "", ProductData.membershipState: ShareData.user_info.membership!, ProductData.person_capacity: "", ProductData.rental_status: "", ProductData.score: "", ProductData.size: "", ProductData.updated_at: ""]
...
//            }
    ...
    extension AddBikeVC:  UIImagePickerControllerDelegate, UINavigationControllerDelegate{
...
extension AddBikeVC: SearchViewControllerDelegate {
...
extension AddBikeVC : UICollectionViewDelegate,UICollectionViewDataSource
{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
