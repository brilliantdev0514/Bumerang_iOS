...
import FirebaseAuth
import Firebase
class AddOtherVC: BaseViewController {
            ...
            self.showALLoadingViewWithTitle(title: "İlanlar yükleniyor ", type: .messageWithIndicator )
                           ...
                           uploadMedia() { url in
                            ...
                            if self.oneProduct != nil {
                                ...
                                self.doGotoUpdateOtherApi(title: titleTxt, priceType: priceOption[self.selectedPeriod], price: priceTxt, description: desciptTxt, image: self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                            } else {
                                
                                self.doGotoUploadOtherApi(title: titleTxt, priceType: priceOption[self.selectedPeriod], price: priceTxt, description: desciptTxt, image: self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                            }
    ...
    func doGotoUpdateOtherApi(title: String, priceType: String, price : String, description : String, image: Array<Any>, addr : String, lat : String, lng : String, zipCode: String) {
    ...
    extension AddOtherVC:  UIImagePickerControllerDelegate, UINavigationControllerDelegate{
...
extension AddOtherVC: SearchViewControllerDelegate {
...
extension AddOtherVC : UICollectionViewDelegate,UICollectionViewDataSource
{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
