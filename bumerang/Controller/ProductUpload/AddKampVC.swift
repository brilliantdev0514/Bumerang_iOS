...
class AddKampVC: BaseViewController {
            ...
            self.showALLoadingViewWithTitle(title: "İlanlar yükleniyor ", type: .messageWithIndicator )
                        ...
                        uploadMedia() { url in
                            ...
                            if self.oneProduct != nil {
                                ...
                                self.doGotoUpdateKampApi(title: titleTxt, priceType: priceOption[self.selectedPeriod], price: priceTxt, description: desciptTxt, image: self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                            } else {
                                
                                self.doGotoUploadKampApi(title: titleTxt, priceType: priceOption[self.selectedPeriod], price: priceTxt, description: desciptTxt, image: self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                            }
    ...
    func doGotoUploadKampApi(title: String, priceType: String, price : String, description : String, image: Array<Any>, addr : String, lat : String, lng : String, zipCode: String){
    ...
    func doGotoUpdateKampApi(title: String, priceType: String, price : String, description : String, image: Array<Any>, addr : String, lat : String, lng : String, zipCode: String){
    ...
    extension AddKampVC:  UIImagePickerControllerDelegate, UINavigationControllerDelegate{
...
extension AddKampVC: SearchViewControllerDelegate {
...
extension AddKampVC : UICollectionViewDelegate,UICollectionViewDataSource
{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
