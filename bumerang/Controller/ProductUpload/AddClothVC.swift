...
class AddClothVC: BaseViewController {
    ...
    @IBOutlet weak var ui_genderDropDown: DropDown!
    @IBOutlet weak var ui_sizeDropDown: DropDown!
    @IBOutlet weak var ui_colorDropDown: DropDown!
    ...
    override func viewDidLoad() {
        ...
        let genderOption = GenderOption()
        ui_genderDropDown.optionArray = genderOption.values
        ui_genderDropDown.optionIds = genderOption.ids
        ui_genderDropDown.checkMarkEnabled = false
        ui_genderDropDown.didSelect{(selectedText , index , id) in
            self.genderState = selectedText
        }
        
        let sizeOption = SizeOption()
        ui_sizeDropDown.optionArray = sizeOption.values
        ui_sizeDropDown.optionIds = sizeOption.ids
        ui_sizeDropDown.checkMarkEnabled = false
        ui_sizeDropDown.didSelect{(selectedText , index , id) in
            self.sizeState = selectedText
        }
        
        let colorOption = ColorOption()
        ui_colorDropDown.optionArray = colorOption.values
        ui_colorDropDown.optionIds = colorOption.ids
        ui_colorDropDown.checkMarkEnabled = false
        ui_colorDropDown.didSelect{(selectedText , index , id) in
            self.colorState = selectedText
        }
    ...
    func updateView() {
           ...
           genderState = oneProduct!.gender
           ui_genderDropDown.text = genderState
        
        sizeState = oneProduct!.size
        ui_sizeDropDown.text = sizeState
        
        colorState = oneProduct!.color
        ui_colorDropDown.text = colorState
   ...
   //MARK:- image select func
    ...
    @IBAction func onClickUpload(_ sender: Any) {
        ...
        let title = ui_titleTxt.text!
        let price = ui_priceTxt.text!
        let descript = ui_descriptionTxtView.text!
        ...
        else if genderState.isEmpty {
            showStr = R_EN.string.ENTER_PRODUCT_PRICETYPE
        }
            
        else if sizeState.isEmpty {
            showStr = R_EN.string.ENTER_PRODUCT_PRICETYPE
        }
            
        else if colorState.isEmpty {
            showStr = R_EN.string.ENTER_PRODUCT_PRICETYPE
        }
            ...
            self.showALLoadingViewWithTitle(title: "İlanlar yükleniyor ", type: .messageWithIndicator )
                  ...
                  imageStrings = url
                    ...
                    if self.oneProduct != nil {
                        ...
                        self.gotoUpdateClothApi(title: title, gender: self.genderState, size: self.sizeState, color:self.colorState, priceType: price, price: price, description : descript, image: self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                    } else {
                        
                        self.gotoUploadClothApi(title: title, gender: self.genderState, size: self.sizeState, color:self.colorState, priceType: price, price: price, description : descript, image: self.uplodimgarray, addr: addrTxt, lat: lat, lng: lng, zipCode: "123456")
                        }
            }
    ...
    func gotoUploadClothApi(title: String, gender: String, size: String, color:String, priceType: String, price : String, description : String, image: Array<Any>, addr : String, lat : String, lng : String, zipCode: String) {
        
        let ownerid = Auth.auth().currentUser!.uid
        let productId = UUID().uuidString
        
        let productDict: [String: Any] = [ProductData.title: title, ProductData.room_number: "", ProductData.heating: "", ProductData.furbished: "", ProductData.date_unit: priceType, ProductData.price: price, ProductData.deposit: "", ProductData.description: description, ProductData.address: addr, ProductData.lat: lat, ProductData.lng: lng, ProductData.zip_code: zipCode, ProductData.owner_id: ownerid, ProductData.image_url: uplodimgarray, ProductData.bed_capacity: "", ProductData.captan: "", ProductData.car_type: "", ProductData.category: "4", ProductData.color: color, ProductData.created_at: "", ProductData.door_number: "", ProductData.fuel_type: "", ProductData.gear_type: "", ProductData.gender: gender, ProductData.membershipState: ShareData.user_info.membership!, ProductData.person_capacity: "", ProductData.rental_status: "", ProductData.score: "", ProductData.size: size, ProductData.updated_at: "", ProductData.product_id: productId]
    ...
    func gotoUpdateClothApi(title: String, gender: String, size: String, color:String, priceType: String, price : String, description : String, image: Array<Any>, addr : String, lat : String, lng : String, zipCode: String) {
        
        let ownerid = Auth.auth().currentUser!.uid
        
        let productDict: [String: Any] = [ProductData.title: title, ProductData.room_number: "", ProductData.heating: "", ProductData.furbished: "", ProductData.date_unit: priceType, ProductData.price: price, ProductData.deposit: "", ProductData.description: description, ProductData.address: addr, ProductData.lat: lat, ProductData.lng: lng, ProductData.zip_code: zipCode, ProductData.owner_id: ownerid, ProductData.image_url: uplodimgarray, ProductData.bed_capacity: "", ProductData.captan: "", ProductData.car_type: "", ProductData.category: "5", ProductData.color: color, ProductData.created_at: "", ProductData.door_number: "", ProductData.fuel_type: "", ProductData.gear_type: "", ProductData.gender: gender, ProductData.membershipState: "", ProductData.person_capacity: "", ProductData.rental_status: "", ProductData.score: "", ProductData.size: size, ProductData.updated_at: ""]
    ...
    extension AddClothVC:  UIImagePickerControllerDelegate, UINavigationControllerDelegate{
...
extension AddClothVC: SearchViewControllerDelegate {
...
extension AddClothVC : UICollectionViewDelegate,UICollectionViewDataSource
{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
