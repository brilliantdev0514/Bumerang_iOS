...
class StandardInfoVC: BaseViewController {
...
extension StandardInfoVC: UICollectionViewDelegate {
...
extension StandardInfoVC : UICollectionViewDataSource {
...
extension StandardInfoVC : UICollectionViewDelegateFlowLayout {
