...
class CaravanDetailVC: BaseViewController {
    ...
    @IBOutlet weak var ui_txtFuel: UILabel!
...
//        ui_imgRentState.isHidden = !oneData.rental_status
        ...
        ui_txtBed.text = "Yatak Kapasitesi : \(String(oneData.bed_capacity))"
...
//        ui_imgFace.image = UIImage(named: "ic_facebook_" + (oneData.userinfo_mailState ? "verified" : "unverified"))
    ...
    @IBAction func onClickUpdate(_ sender: Any) {
        ...
        let toVC = self.storyboard?.instantiateViewController( withIdentifier: "AddCaravanVC") as! AddCaravanVC
...
extension CaravanDetailVC: UICollectionViewDataSource,UICollectionViewDelegate{
