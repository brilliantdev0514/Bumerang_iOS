...
class ClothDetailVC: BaseViewController {

    var productUser : Users? = nil
    var oneProduct : ProductModels? = nil
    
    @IBOutlet weak var ui_lblGender: UITextField!
    @IBOutlet weak var ui_lblSize: UITextField!
    @IBOutlet weak var ui_lblColor: UITextField!
...
//        ui_imgRentState.isHidden = !oneData.rental_status
        ...
        ui_lblGender.text = "Cinsiyet : \(String(oneData.gender))"
        ui_lblSize.text = "Beden : \(String(oneData.size))"
        ui_lblColor.text = "Renk : \(String(oneData.color))"
...
//        ui_imgFace.image = UIImage(named: "ic_facebook_" + (oneData.userinfo_mailState ? "verified" : "unverified"))
    ...
    @IBAction func onClickUpdate(_ sender: Any) {
        ...
        let toVC = self.storyboard?.instantiateViewController( withIdentifier: "AddClothVC") as! AddClothVC
...
extension ClothDetailVC: UICollectionViewDataSource,UICollectionViewDelegate{
