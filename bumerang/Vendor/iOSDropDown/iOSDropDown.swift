...
*/
    ...
    //MARK: Closures
    var didSelectCompletion: (String, Int ,Int) -> () = {selectedText, index , id  in }
    var TableWillAppearCompletion: () -> () = { }
    var TableDidAppearCompletion: () -> () = { }
    var TableWillDisappearCompletion: () -> () = { }
    var TableDidDisappearCompletion: () -> () = { }
    ...
    //   table.layer.borderColor = #colorLiteral(red: 0.8507481217, green: 0.3468235731, blue: 0.3539260924, alpha: 1)
